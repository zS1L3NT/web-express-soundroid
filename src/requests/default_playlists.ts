...
export default async (
	...
	const COMTPlaylist: Playlist = {
		...
		userId,
		queries: getQueries("COMT Default")
	}
	const COMTSongs: Song[] = [
		{
			...
			userId,
			queries: getQueries("The Way You Look Tonight")
		},
		{
            songId: "Kr4EQDVETuA",
            title: "Billie Jean",
            ...
            playlistId: COMTPlaylistId,
            userId,
            queries: getQueries("Billie Jean")
        },
        {
            songId: "SlbfAYvA_gI",
            title: "Photograph",
	...
	const IUPlaylist: Playlist = {
		...
		colorHex: "#A88867",
		userId,
		queries: getQueries("IU Best Songs")
	}
	const IUSongs: Song[] = [
		{
			songId: "v7bnOxV4jAc",
